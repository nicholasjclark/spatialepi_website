...
```{r, echo = FALSE, warning=FALSE, message=FALSE}
kable(data.frame(all_pubs %>%
          dplyr::filter(Year > 2014)), row.names = F,
      format = 'html') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  column_spec(2, width = '30em') %>%
  column_spec(3, italic = T, width = '20em') %>%
...
<center>Uttara Kennedy has worked for 18 years as a small animal veterinarian, practice manager and mentor to young vets across Australia and India, including volunteering in India with Vets Beyond Borders for their TNR (trap-neuter-release) program. She has an MSc in International Animal Welfare, Ethics and Law and a Member of the ANZVCS (Animal Welfare chapter). She currently works as a shelter veterinarian at the RSPCA Queensland’s largest city shelter. Her years with the RSPCA has given her deep insight into the challenges and issues pertaining to shelter medicine and control of endemic diseases in the shelter environment. She started her PhD in January 2021, to explore the epidemiology of diseases through animal shelters in Australia. She has co-authored papers on cattle welfare in India, and Australian invasive pest control strategies. She loves disappearing into the bush on long hiking-camping adventures with her family, when she is not working or studying.</center> 
...
### Thomas Callaghan
<img src="images/Thomas.jpg" class="round" style="border:4px solid; margin-bottom: 20px" alt="Thomas Cakkaghna is a PhD student at the Spatial Epidemiology Group, University of Queensland"/>
